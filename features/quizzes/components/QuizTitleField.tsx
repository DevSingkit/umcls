    ...
    return (
        <div className="bg-surface rounded-md border border-hairline shadow-card p-6">
            ...
            <input
                ...
                aria-required="true"
                className={`w-full h-13 px-4 text-body-emphasis text-ink bg-surface rounded-md border-2 focus:outline-none focus-visible:ring-2 focus-visible:ring-brand focus-visible:ring-offset-2 transition-colors ${
                    error ? 'border-error focus-visible:ring-error' : 'border-hairline focus:border-brand'
                }`}
            />
